CACHECA is a cache language model-based code completion tool for Eclipse's Java editor. The associated tool demonstration paper is to appear at ICSE 2015 in Florence, Italy.
